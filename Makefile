...
LIBS          = $(SUBLIBS) -L/usr/local/lib/ -L/opt/ffmpeg-arm/lib/ -lavcodec -lavformat -lavdevice -lavfilter -lavutil -lpostproc -lswresample -lswscale -L/opt/x264-arm/lib -lx264 -L/opt/SDL-arm/lib/ -lSDL -L/qt-5.5.0-install/lib -lQt5Widgets -lQt5Gui -lQt5Network -lQt5SerialPort -lQt5Core -lpthread 
AR            = arm-linux-ar cqs
RANLIB        = 
SED           = sed
...
SOURCES       = main.cpp \
		...
		screenemotion/screenemotion.cpp qrc_res.cpp \
		moc_mainwindow.cpp \
		moc_keyboard.cpp \
		moc_usb_wifi.cpp \
		moc_videoplayer.cpp \
...
DIST          = /qt-5.5.0-install/mkspecs/features/spec_pre.prf \
		...
		keyinput.h \
		SSDB/ssdb_client_.h \
		screenemotion/screenemotion.h main.cpp \
		mainwindow.cpp \
		keyboard/keyboard.cpp \
		net/usb_wifi.cpp \
		videoplayer/videoplayer.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.h keyboard/keyboard.h net/usb_wifi.h videoplayer/video.h videoplayer/videoplayer.h serialport/serialport.h global.h net/ipinfotable.h SSDB/buffer.h SSDB/ssdb_client.h net/downloader.h net/netspeed.h keyinput.h SSDB/ssdb_client_.h screenemotion/screenemotion.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp mainwindow.cpp keyboard/keyboard.cpp net/usb_wifi.cpp videoplayer/videoplayer.cpp serialport/serialport.cpp net/ipinfotable.cpp SSDB/ssdb_client.cpp SSDB/buffer.c global.cpp net/downloader.cpp net/netspeed.cpp keyinput.cpp SSDB/ssdb_client_.cpp screenemotion/screenemotion.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_keyboard.cpp moc_usb_wifi.cpp moc_videoplayer.cpp moc_serialport.cpp moc_ipinfotable.cpp moc_downloader.cpp moc_netspeed.cpp moc_keyinput.cpp moc_ssdb_client_.cpp moc_screenemotion.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_keyboard.cpp moc_usb_wifi.cpp moc_videoplayer.cpp moc_serialport.cpp moc_ipinfotable.cpp moc_downloader.cpp moc_netspeed.cpp moc_keyinput.cpp moc_ssdb_client_.cpp moc_screenemotion.cpp
